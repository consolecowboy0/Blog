...
export async function GET({ request }) {
  ...
  try {
    ...
    return json({ error: 'Failed to fetch subscribers' }, 500, corsHeaders);
  }
}
...
export async function POST({ request }) {
  ...
  try {
    ...
    return json({ error: 'Failed to add subscriber' }, 500, corsHeaders);
  }
}
...
export async function PATCH({ request }) {
  ...
  try {
    ...
    return json({ error: 'Failed to update subscriber' }, 500, corsHeaders);
  }
}
...
export async function DELETE({ request }) {
  ...
  try {
    ...
    return json({ error: 'Failed to delete subscriber' }, 500, corsHeaders);
  }
}
