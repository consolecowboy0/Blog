...
![The Caviar network- 110 nodes colored by community, sized by connection count. Seven clusters orbiting one massive hub.](/images/charts/hero_network.png)

Seven distinct clusters. Seven ecosystems of trust and transaction.
...
![The network before and after The Detective's four moves. Red X marks show the removed nodes. What was one connected whole is now scattered fragments.](/images/charts/hero_before_after.png)
